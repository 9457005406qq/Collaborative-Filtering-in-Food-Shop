...
def data():
    ...
    ratings_train = pd.read_csv(r'E:\SRT\data\newtrain100.csv', names=rs_cols, index_col=False, header=None)
    ratings_test = pd.read_csv(r'E:\SRT\data\newtest100.csv', names=rs_cols, index_col=False, header=None)
    ...
    for line in ratings_train.itertuples():
        if(line[3]!=0):
            train_matrix[line[1], line[2]]=1.0
        else:
            train_matrix[line[1], line[2]]=0.0
